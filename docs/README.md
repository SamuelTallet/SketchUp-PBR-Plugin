...
3. Download latest PBR plugin in .RBZ format from [Releases](https://github.com/SamuelTS/SketchUp-PBR-Plugin/releases/) or the [SketchUcation PluginStore](https://sketchucation.com/pluginstore?pln=pbr).
