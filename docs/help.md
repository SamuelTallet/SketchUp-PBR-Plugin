...
I don't see last changes done in SketchUp. | Reopen PBR Viewport from SketchUp "Extensions" menu. If problem persists, press <kbd>Ctrl</kbd> + <kbd>F5</kbd> to force the reload.
