...
Je ne vois pas les derniers changements effectués dans SketchUp. | Réouvrez la fenêtre de visualisation RBP à partir du menu "Extensions" de SketchUp. Si le problème persiste, appuyez sur <kbd>Ctrl</kbd> + <kbd>F5</kbd> dans le navigateur pour forcer le rechargement.
